...
import { Input, Checkbox, Form, InputNumber, Select } from "antd";
import { motion } from "framer-motion";

const { Option } = Select;

const ShippingBillingStep = ({
  form,
  onBack,
  onSubmit,
  customerData,
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Enter shipping and billing details for the order
        </p>
      </div>
...
export default ShippingBillingStep;
