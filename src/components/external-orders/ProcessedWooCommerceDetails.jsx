          ...
          <div className="mb-4 p-3 bg-purple-50 rounded-lg border border-purple-200">
            <div className="space-y-2">
              {mergedProducts.map((mergedProduct, index) => {
                ...
                const firstProduct = order?.line_items?.find(
                  (item) => String(item?.product_id || item?.id) === String(firstProductId)
                );
                  ...
                  >
                    <div className="flex-1">
                      <div className="font-medium text-gray-900">
                        {mergedProduct?.productName || firstProduct?.name || "Merged Product"}
                      </div>
                      <div className="text-sm text-gray-600">
                        SKU: {mergedProduct?.sku || "N/A"} | Qty: {mergedProduct?.quantity || 1}
                      </div>
