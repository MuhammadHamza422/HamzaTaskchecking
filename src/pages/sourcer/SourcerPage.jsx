...
// // // Money with commas and minus BEFORE the dollar, e.g. "- $1,234.56"
...
// // // Percent with commas and sign (no % prefix spacing), e.g. "-12.34%"
...
// // /* ---------- Tooltip helpers (render to body + high z-index) ---------- */
// // const tipCommon = {
...
// //     async (diffArr) => {
// //       try {
// //         if (!isEdit || !id || !Array.isArray(diffArr) || !diffArr.length)
// //           return;
...
// //     const resolvedType =
// //       p.product_type || TYPE_CODE_TO_NAME[code] || ProductType.Game;
...
// //         Number(p.target_cost_per_unit ?? p.target_cost) || 0,
// //       quantity_needed: 1,
// //       sourced_price: 0,
// //     });
// //   };
...
// //         (sum, i) =>
// //           sum + toNum(i.target_cost_per_unit) * toNum(i.quantity_needed),
// //         0
// //       ),
// //     [cart.rawItems]
// //   );
...
// //   // Savings: Target − Actual (money)
// //   const totalSavings = useMemo(
// //     () => targetTotalCost - totalActualCost,
// //     [targetTotalCost, totalActualCost]
// //   );

// //   // Efficiency %: (Savings ÷ Target) × 100 (percentage alternative of Savings)
...
// //     () =>
// //       cart.rawItems.reduce(
// //         (n, it) => n + (toNum(it.target_cost_per_unit) > 0 ? 0 : 1),
// //         0
// //       ),
// //     [cart.rawItems]
// //   );
...
// //         return apiClient.put(`/api/v1/products/sku/${sku}/target-cost`, {
// //           target_cost: cost,
// //         });
// //       });
...
// //     failed.forEach((r) =>
// //       console.error(
// //         "target_cost update failed:",
// //         r.reason?.response?.data || r.reason
// //       )
// //     );
// //     return {
// //       ok: failed.length === 0,
...
// //     const q = String(lastMarketQuery.current || "")
// //       .trim()
// //       .toLowerCase();
...
// //       // ensure seller on this market if already typed
// //       const h = form.getFieldValue("header") || {};
// //       const sellerName = (h.seller_name || "").trim();

// //       if (sellerName) {
// //         try {
// //           const { data: s } = await apiClient.post(
...
// //           form.setFieldsValue({
// //             header: { ...h2, market: slug, seller_id: undefined },
// //           });
// //           toastError(
// //             "Could not ensure seller",
...
// //           ...baseToast,
// //           icon: "info",
// //           title: "Please select a marketplace first",
// //         });
// //         return;
// //       }
// //       try {
// //         const { data } = await apiClient.post(
// //           "/api/v1/sellers/find-or-create",
// //           { name: createName, market }
// //         );
// //         const h = form.getFieldValue("header") || {};
// //         form.setFieldsValue({
// //           header: { ...h, seller_name: data.name, seller_id: data._id },
// //         });
...
// //       const h = form.getFieldValue("header") || {};
// //       form.setFieldsValue({
// //         header: { ...h, seller_name: option?.label, seller_id: val },
// //       });
// //     }
// //   };
...
// //           data?.seller?.market || data?.market || ""
// //         );
...
// //           (s, it) => s + toNum(it.quantity_needed || 1),
// //           0
// //         );
// //         const orderTargetTotal = toNum(data?.target_total_cost);
// //         const derivedTargetPerUnit =
// //           totalUnits > 0 && orderTargetTotal > 0
// //             ? orderTargetTotal / totalUnits
// //             : 0;
...
// //             target_cost_per_unit:
// //               toNum(it.target_cost_per_unit) || derivedTargetPerUnit,
...
// //   ) => {
// //     const sellerAlloc =
// //       targetTotalCostNum > 0 ? sellersPriceNum / targetTotalCostNum : 0;
// //     const actualAlloc =
// //       targetTotalCostNum > 0 ? totalActualCostNum / targetTotalCostNum : 0;
...
// //     }
// //     if (
// //       cartRef.current.rawItems.some(
// //         (it) => !(toNum(it.target_cost_per_unit) > 0)
// //       )
// //     ) {
// //       Swal.fire({
// //         ...baseToast,
...
// //           `${upd.failed}/${upd.total} target costs failed to save to product.`
// //         );
// //       }
...
// //         purchase_efficiency: toFixedN(liveTargetTotal - liveActualTotal, 4), // raw money saving for backend (optional)
...
// //         toastSuccess(
// //           "Record Updated!",
// //           "Your sourcing order has been updated."
// //         );
// //       } else {
...
// //           "Your sourcing order has been created."
// //         );
// //       }
...
// //         title: colTitle(
// //           "Target Cost / unit",
// //           "Per-unit target cost for this item."
// //         ),
...
// //           return (
// //             <span style={{ fontWeight: 700 }}>{fmtMoneySigned(qty * tpu)}</span>
// //           );
// //         },
// //       },
// //       {
...
// //         title: colTitle(
// //           "Saving / Unit",
// //           "Target Cost / unit − Actual cost / unit. Positive = under target (saved); negative = over target."
// //         ),
// //         key: "saving_per_unit",
// //         width: 170,
// //         align: "center",
...
// //         >
// //           <Title level={3}>
// //             {isEdit ? "Edit Sourcing Order" : "New Sourcing Order"}
// //           </Title>
// //         </motion.div>
...
// //                 label="Listing Link"
// //                 tooltip={{
// //                   title: "URL to the product listing (http/https).",
// //                   ...tipCommon,
// //                 }}
// //                 hasFeedback
// //                 validateFirst
...
// //                       form.setFieldsValue({
// //                         header: { ...current, listing_link: fixed },
// //                       });
// //                     }
// //                   }}
// //                   onPressEnter={(e) => {
...
// //                 tooltip={{
// //                   title:
// //                     "Pick an existing marketplace or create one (slug, e.g. 'ebay').",
// //                   ...tipCommon,
// //                 }}
// //                 rules={[
...
// //                 tooltip={{
// //                   title:
// //                     "Choose an existing seller for the selected marketplace or create a new one.",
// //                   ...tipCommon,
// //                 }}
// //                 rules={[
// //                   {
// //                     required: true,
// //                     message: "Please select or create a seller",
// //                   },
// //                 ]}
// //               >
// //                 <Select
...
// //                   }}
// //                   value={
// //                     form.getFieldValue(["header", "seller_name"]) || undefined
// //                   }
// //                 />
// //               </Form.Item>
// //             </Col>
...
// //                 label="Origin"
// //                 tooltip={{
// //                   title: "Select the shipping origin country for this order.",
// //                   ...tipCommon,
// //                 }}
// //                 rules={[
...
// //                         ? Promise.resolve()
// //                         : Promise.reject(
// //                             new Error("Please select a country from the list")
// //                           );
// //                     },
// //                   }),
// //                 ]}
...
// //                         const title =
// //                           p.pro_title || p.product_name || "Untitled";
// //                         const sku = p.sku || "";
// //                         return (
// //                           <div
// //                             key={idp}
...
// //               flexWrap: "nowrap",
// //               overflowX: "auto", // keep one line; scroll if needed
// //               paddingBottom: 4, // avoid scrollbar overlap
// //             }}
// //           >
// //             <Statistic
// //               title={statTitle(
// //                 "Total Target Cost",
// //                 "Σ (Qty × Target cost / unit) for all items"
// //               )}
...
// //                 label="Seller Price ($)"
// //                 tooltip={{
// //                   title: "Order-level amount paid to the seller.",
// //                   ...tipCommon,
// //                 }}
// //               >
// //                 <InputNumber
...
// //                 tooltip={{
// //                   title:
// //                     "Order-level shipping charges (not per-unit). Included in Total Actual Cost.",
// //                   ...tipCommon,
// //                 }}
// //               >
// //                 <InputNumber
...
// //                 tooltip={{
// //                   title:
// //                     "Order-level taxes for this purchase. Included in Total Actual Cost.",
// //                   ...tipCommon,
// //                 }}
// //               >
// //                 <InputNumber
...
// //             disabled={
// //               !cart.rawItems.length || invalidTargetsCount > 0 || isSubmitting
// //             }
// //             style={{
...
// /* ---------------- shipping mode radio (Tailwind cards) ---------------- */

// function ShippingModeRadio({ value = "supplier", onChange }) {
//   const options = [
//     {
//       key: "supplier",
//       title: "Shipping by supplier",
//       desc: "Seller handles shipping to you.",
//       Icon: ShopOutlined,
//     },
//     {
//       key: "self",
//       title: "Self managed",
//       desc: "You manage shipping (in-house/3PL).",
//       Icon: CarOutlined,
//     },
//   ];
...
//             key={key}
//             className={[
//               "group relative w-full cursor-pointer rounded-xl border p-3 transition",
//               active
...
//             shipping_charges: toNum(data?.shipping_charges),
//             taxes: toNum(data?.taxes),
//             // NEW: load persisted shipping mode, default to 'supplier'
...
//               {/* NEW: Tailwind radio cards for Shipping Mode */}
//               <Form.Item
//                 name={["totals", "shipping_mode"]}
//                 label="Shipping Mode"
//                 tooltip={{
//                   title: "Choose who manages shipping for this order.",
//                   ...tipCommon,
//                 }}
...
//                 <InfoCircleOutlined />{" "}
//                 {form.getFieldValue(["totals", "shipping_mode"]) === "self"
//                   ? "You’re handling shipping (in-house/3PL)."
        ...
        return (
          ...
          >
            <input
              ...
              onChange={() => onChange?.(key)}
            />
            <Icon style={{ fontSize: 12 }} className={active ? "mr-1" : "mr-1"} />
            {label}
          </label>
        );
      })}
        ...
        render: (_v, rec) => (
          <Button
            ...
            onClick={async () => {
              cart.remove(rec.id);
              await logItemsOps([
                { op: "REMOVE", name: rec.product_name || "Item", sku: rec.sku || undefined, qty: rec.quantity_needed ?? undefined },
              ]);
            }}
          />
        ),
        ...
        <Card style={gradientStyle}>
          <Row gutter={[12, 12]}>
            ...
            <Col xs={24} sm={8}>
              ...
              {/* COMPACT SHIPPING MODE */}
              <Form.Item
                name={["totals", "shipping_mode"]}
                label="Shipping Mode"
                tooltip={{ title: "Choose who manages shipping for this order.", ...tipCommon }}
                rules={[{ required: true, message: "Please select a shipping mode" }]}
                // ensure Form controls custom component via value/onChange
                valuePropName="value"
              >
                <ShippingModeRadio />
              </Form.Item>
