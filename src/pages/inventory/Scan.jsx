    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 font-sans">Product Search</h1>
            {mode !== "select" && (
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-slate-900 font-sans">Scan Product</h3>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-500 font-sans">Type product name or code</p>
                    </div>
            ...
            <div className="text-center space-y-2">
              ...
              {isSearching && (
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm text-blue-600 font-sans">Searching products...</span>
                </div>
              )}
            </div>
          ...
          <div className="space-y-6">
            ...
            {searchResults.length === 0 && searchQuery && !isSearching && (
              <div className="p-8 text-center bg-white rounded-xl border-2 border-dashed border-slate-200">
                ...
                <h3 className="font-semibold text-slate-600 font-sans mb-1">No products found</h3>
