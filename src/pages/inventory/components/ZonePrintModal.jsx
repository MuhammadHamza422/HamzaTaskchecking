...
export default function ZonePrintModal({
  isOpen,
  onClose,
  zones = [],
  selectedIds = new Set(),
        ...
        <head>
          ...
          <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .type-header { text-align: center !important; padding: 0.08in 0.05in !important; text-transform: uppercase !important; font-weight: bold !important; font-size: 14px !important; letter-spacing: 0.5px !important; background: #f8f8f8 !important; color: black !important; }
            .info-row { display: flex !important; border-top: 1px solid black !important; font-size: 14px !important; height: 0.4in !important; color: black !important; }
            .info-row:last-child { border-bottom: none !important; flex: 1 !important; }
            .info-label { width: 0.8in !important; padding: 0.05in !important; text-transform: uppercase !important; font-weight: 600 !important; border-right: 1px solid black !important; background: #f8f8f8 !important; display: flex !important; align-items: center !important; font-size: 10px !important; color: black !important; }
            .info-value { flex: 1 !important; padding: 0.05in !important; display: flex !important; align-items: center !important; font-size: 11px !important; color: black !important; font-weight: 500 !important; line-height: 1.2 !important; word-wrap: break-word !important; overflow-wrap: break-word !important; }
  ...
  const filteredZones = zones.filter(
    (z) => selectedIds.size === 0 || selectedIds.has(z.id)
  );

  const itemsPerPage = 1;
  const totalPages = filteredZones.length;
        ...
        <div className="bg-white w-full">
          <div className="flex items-center justify-between border-b px-4 pb-2 no-print">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {filteredZones.length} labels • {totalPages} pages • 1 label
                per page
              </p>
            </div>
          ...
          <div className="overflow-auto p-4 max-w-4xl mx-auto">
            <div ref={printRef} className="grid grid-cols-2 gap-4">
              {filteredZones.map((zone, pageIndex) => (
                  ...
                  >
                    ...
                    <div className="label-card w-full h-full border border-black flex bg-white">
                      ...
                      <div className="info-container border-l border-black text-black flex-1 h-full flex flex-col">
                        {/* Type Header */}
                        <div className="type-header text-center border-b border-black bg-gray-50 py-2 px-1">
                          <p className="uppercase text-sm font-semibold tracking-wide text-black">
                            ZONE
                          </p>
                        </div>
                        ...
                        <div className="info-row flex flex-1">
                          ...
                          <div className="info-value flex items-center px-1">
                            <span className="text-xs font-medium text-black">
                              {zone.type === "not_shelf" ? "Not Shelf" : zone.type || "Shelf"}
                            </span>
                          </div>
                        </div>
                      </div>
