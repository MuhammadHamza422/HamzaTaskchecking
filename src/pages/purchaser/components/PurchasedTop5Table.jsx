...
export default function PurchasedTop5Table({
  ...
  return (
    <div
      className="relative overflow-hidden rounded-[14px] transition-all duration-150 hover:shadow-md"
      style={SOURCER_CARD_STYLE}
    >
      {/* Neutral header (matches AdminOps lists) */}
      <div
        className="
          flex items-center justify-between
          px-3 py-2
